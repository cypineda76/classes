 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://webservice.wsejemplo.ucatolica.org/", wsdlLocation = "http://localhost:8089/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8089/WS/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://webservice.wsejemplo.ucatolica.org/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.wsejemplo.ucatolica.org/", "CalculadoraImplPort"), Calculadora.class, features);
    }
