 ...
 * generated in the org.ucatolica.wsejemplo.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sumar_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "sumar");
    private final static QName _DividirResponse_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "multiplicar");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "multiplicarResponse");
    private final static QName _SumarResponse_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "sumarResponse");
    private final static QName _RestarResponse_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "restarResponse");
    private final static QName _Restar_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "restar");
    private final static QName _Dividir_QNAME = new QName("http://webservice.wsejemplo.ucatolica.org/", "dividir");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.ucatolica.wsejemplo.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "restarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.wsejemplo.ucatolica.org/", name = "dividir")
